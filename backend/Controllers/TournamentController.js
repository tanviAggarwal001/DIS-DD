...
exports.createTournament = async (req, res) => {
  try {
    ...
    const { name, game_id, start_date, end_date, created_by, members_per_match } = req.body;
    const tournament = await Tournament.create(name, game_id, start_date, end_date, created_by, members_per_match);
